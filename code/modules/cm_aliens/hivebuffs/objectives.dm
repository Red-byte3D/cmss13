...
// ---------------------------------------------------------------------------
// Ported from the pre-Globber boiler bombard, removed in #965 (6f1b1717a7).
// Spreads a telegraphed circle of acid globs outward from the target turf,
// which damage and then gas after a short delay.
// ---------------------------------------------------------------------------
